      ...
      <DialogContent className='bg-white text-black p-0 overflow-hidden'>
        <DialogHeader className='pt-4 px-3'>
          ...
          <DialogDescription className='text-center font-bold text-zinc-500'>
            Give your server a personality with a name and and an image. You can
          ...
          <form className='space-y-4' onSubmit={form.handleSubmit(onSubmit)}>
            <div className='px-6'>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className='uppercase text-xs font-bold text-zinc-500 dark:text-secondary/50'>
                      Server Name
                    </FormLabel>
                    <FormControl>
                      <Input
